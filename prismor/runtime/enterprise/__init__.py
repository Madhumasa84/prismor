...
This package groups everything that connects a local Prismor install to an
...
Telemetry upload itself lives in ``prismor.runtime.sinks`` (the generic sink layer);
...
# `import prismor.runtime.enterprise` exposes every submodule without circular-import
# surprises. Code on the hot path still imports lazily inside functions.
from prismor.runtime.enterprise import identity  # noqa: F401
from prismor.runtime.enterprise import telemetry  # noqa: F401
from prismor.runtime.enterprise import telemetry_spool  # noqa: F401
from prismor.runtime.enterprise import heartbeat  # noqa: F401
from prismor.runtime.enterprise import remote_policy  # noqa: F401
from prismor.runtime.enterprise import workspace_scope  # noqa: F401
