...
``warden.runtime.evaluate_tool_call`` before the action executes — same
...
__all__ = ["guard_controller", "use_subject", "WardenBlocked"]
...
def guard_controller(
    ...
    *,
    ...
    action through the Warden policy engine before Playwright executes it.
    ...
    if getattr(registry, "__warden_guarded__", False):
        return controller
