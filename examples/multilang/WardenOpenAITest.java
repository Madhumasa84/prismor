/**
 * Java 21 — real OpenAI function-calling + Warden eval-server interception.
...
public class WardenOpenAITest {
    ...
    // ── warden check ─────────────────────────────────────────────────────────────
    static boolean wardenAllow(String toolName, String argsJson, String mode, String subject) {
        try {
    ...
    static void agentTurn(String prompt, String mode, String subject) throws Exception {
        ...
        while (nameM.find() && argsM.find()) {
            ...
            boolean allow = wardenAllow(name, argsRaw, mode, subject);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("╔══════════════════════════════════════════════════════╗");
        System.out.println("║  Java 21 + OpenAI function calling + Warden eval     ║");
        System.out.println("╚══════════════════════════════════════════════════════╝");
